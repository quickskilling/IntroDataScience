...
def __():
    ...
    import marimo as mo
    return datetime, go, mo, pl, px


@app.cell(hide_code=True)
def __(mo):
    mo.md(r"""## Part 1: Load and Explore Data""")
    return
...
@app.cell(hide_code=True)
def __(mo):
    mo.md(r"""## Part 2: Filtering Practice""")
    return
...
@app.cell(hide_code=True)
def __(mo):
    mo.md(r"""## Part 3: Selecting and Creating Columns""")
    return
...
@app.cell(hide_code=True)
def __(mo):
    mo.md(r"""## Part 4: Working with Sales Data""")
    return
...
@app.cell(hide_code=True)
def __(mo):
    mo.md(r"""## Part 5: Aggregations and Grouping""")
    return
...
@app.cell(hide_code=True)
def __(mo):
    mo.md(r"""## Part 6: Date Operations""")
    return
...
@app.cell(hide_code=True)
def __(mo):
    mo.md(r"""## Part 7: Your First Plot - Bar Chart""")
    return


@app.cell
def __(category_sales, px):
...
@app.cell(hide_code=True)
def __(mo):
    mo.md(r"""## Part 8: Line Chart - Sales Over Time""")
    return


@app.cell
def __(monthly_sales, px):
...
@app.cell(hide_code=True)
def __(mo):
    mo.md(r"""## Part 9: Scatter Plot - Exploring Relationships""")
    return
...
@app.cell(hide_code=True)
def __(mo):
    mo.md(r"""## Part 10: Histogram - Distribution Analysis""")
    return
...
@app.cell(hide_code=True)
def __(mo):
    mo.md(r"""## Part 11: Box Plot - Compare Distributions""")
    return
...
@app.cell(hide_code=True)
def __(mo):
    mo.md(r"""## Part 12: Advanced - Multiple Subplots""")
    return
...
@app.cell(hide_code=True)
def __(mo):
    mo.md(r"""## Part 13: Challenge - Answer This Question""")
    return
...
def __(sales):
    ...
    return region_category_counts, top_category_per_region


@app.cell
def __(px, top_category_per_region):
